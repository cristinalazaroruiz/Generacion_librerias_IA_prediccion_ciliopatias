...
Primeramente, con el script orphanet_informacion.py, se ha procesado el XML hasta generar el Anexo 4, que contiene información sobre todas las enfermedades control y sus términos HPO asociados sin clasificar.
...
Por úlitmo, en el script clasificacion_HPO.py, se han clasificado los términos HPO siguiendo el mismo formato que los datos de ciliopatías, hasta dar lugar al Anexo 5. Para esta clasificación, se ha usado el fichero hp.obo, obtenido de https://github.com/obophenotype/human-phenotype-ontology?tab=readme-ov-file
